...
def find_graph_modules(agents_dir: str = "src/agents") -> list[str]:
...
def find_graphs_in_module(module_path: str) -> dict[str, Union[Graph, StateGraph]]:
    ...
    try:
        ...
        for name, obj in inspect.getmembers(module):
            # Check if the object is a Graph instance or has a get_graph method
            ...
            # Check if the object is a function that creates a graph
            elif is_graph_creator_function(obj):
                try:
...
def main():
    ...
    if all_graphs:
        ...
        print("No graphs found in the agents directory.")
